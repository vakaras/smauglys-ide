...
nameShort='setpath(["nameShort"]; "Smauglys")'
nameLong='setpath(["nameLong"]; "Smauglys")'
linuxIconName='setpath(["linuxIconName"]; "smauglys")'
applicationName='setpath(["applicationName"]; "smauglys")'
win32MutexName='setpath(["win32MutexName"]; "smauglys")'
win32DirName='setpath(["win32DirName"]; "Smauglys")'
win32NameVersion='setpath(["win32NameVersion"]; "Smauglys")'
win32RegValueName='setpath(["win32RegValueName"]; "Smauglys")'
win32AppUserModelId='setpath(["win32AppUserModelId"]; "Microsoft.Smauglys")'
win32ShellNameShort='setpath(["win32ShellNameShort"]; "Smauglys")'
win32x64UserAppId='setpath (["win32x64UserAppId"]; "{{845C5956-CA04-4614-BD3E-42957794F415}")'
urlProtocol='setpath(["urlProtocol"]; "smauglys")'
