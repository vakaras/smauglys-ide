...
nameShort='setpath(["nameShort"]; "nsapython")'
nameLong='setpath(["nameLong"]; "LR NŠA Python")'
linuxIconName='setpath(["linuxIconName"]; "nsapython")'
applicationName='setpath(["applicationName"]; "nsapython")'
win32MutexName='setpath(["win32MutexName"]; "nsapython")'
win32DirName='setpath(["win32DirName"]; "LR NSA Python")'
win32NameVersion='setpath(["win32NameVersion"]; "LR NSA Python")'
win32RegValueName='setpath(["win32RegValueName"]; "LR NSA Python")'
win32AppUserModelId='setpath(["win32AppUserModelId"]; "Microsoft.LR NSA Python")'
win32ShellNameShort='setpath(["win32ShellNameShort"]; "LR NSA Python")'
win32x64UserAppId='setpath (["win32x64UserAppId"]; "{{2E1F05D1-C245-4562-81EE-28188DB6FD17}")'
urlProtocol='setpath(["urlProtocol"]; "nsapython")'
