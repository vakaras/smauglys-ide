...
nameShort='setpath(["nameShort"]; "LR NŠA Python")'
nameLong='setpath(["nameLong"]; "LR NŠA Python")'
linuxIconName='setpath(["linuxIconName"]; "nsa-python")'
applicationName='setpath(["applicationName"]; "nsa-python")'
win32MutexName='setpath(["win32MutexName"]; "nsa-python")'
win32DirName='setpath(["win32DirName"]; "LR NŠA Python")'
win32NameVersion='setpath(["win32NameVersion"]; "LR NŠA Python")'
win32RegValueName='setpath(["win32RegValueName"]; "LR NŠA Python")'
win32AppUserModelId='setpath(["win32AppUserModelId"]; "Microsoft.LR NŠA Python")'
win32ShellNameShort='setpath(["win32ShellNameShort"]; "LR NŠA Python")'
win32x64UserAppId='setpath (["win32x64UserAppId"]; "{{845C5956-CA04-4614-BD3E-42957794F415}")'
urlProtocol='setpath(["urlProtocol"]; "nsa-python")'
serverApplicationName='setpath(["serverApplicationName"]; "smauglys-server")'
serverDataFolderName='setpath(["serverDataFolderName"]; ".smauglys-server")'
reportIssueUrl='setpath(["reportIssueUrl"]; "https://github.com/vakaras/smauglys/issues/new/")'
licenseUrl='setpath(["licenseUrl"]; "https://github.com/vakaras/smauglys/blob/main/LICENSE")'
